  ...
  return (
    <section className='w-full max-w-6xl mx-auto bg-dark-tertiary p-10'>
      ...
      >
        ...
        >
          <article
            className={`p-6 text-dark-primary space-y-6 h-[34.375rem] ${poppins.className}`}
          >
            <p>
            ...
            <p>
              ...
              from Loan app for your own personal use subjected to restrictions
            ...
            <p>
              ...
              Loan app does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Loan app,its agents and/or affiliates.
              ...
              laws, Loan app shall not be liable for the Comments or for any
            ...
            <p>
              You hereby grant Loan app a non-exclusive license to use,
            ...
            <p>
              ...
              Loan app; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Loan app. Please include your name, your
