import { useState, UIEvent, useContext } from 'react'
import { Modal, Button, ModalContext } from '@/components'
import { useRouter } from 'next/navigation'
import { poppins } from '@/utils'

interface TermsAndConditionModalTypes {
  callback: () => void
  path: 'personal-information' | 'preview-info'
}

export const TermsAndConditionModal = ({
  callback,
  path
}: TermsAndConditionModalTypes): JSX.Element => {
  ...
  return (
    <Modal styles='bg-dark-tertiary w-8/12 h-auto space-y-4'>
      <Modal.title className='text-[2rem] text-center'>
        Terms and Condition
      </Modal.title>
      <Modal.content
        className='bg-white w-full overflow-auto scroll-hidden'
        onScroll={(event: UIEvent) => onScroll(event)}
      >
        <article className={`p-6 space-y-6 h-[25rem] ${poppins.className}`}>
          ...
          <p>
            ...
            conditions. Do not continue to use Loan app if you do not agree to
          ...
          <p>
            Unless otherwise stated, Loan app and/or its licensors own the
            intellectual property rights for all material on Loan app. All
            intellectual property rights are reserved. You may access this from
            Loan app for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Loan app</li>
            <li>Sell, rent or sub-license material from Loan app</li>
            <li>Reproduce, duplicate or copy material from Loan app</li>
            <li>Redistribute content from Loan app</li>
          </ul>
          ...
          <p>
            ...
            Loan app does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Loan app,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Loan app shall
          ...
          <p>
            Loan app reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Loan app a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Loan app; and
          ...
          <p>
            ...
            sending an e-mail to Loan app. Please include your name, your
